...
namespace Device::Commands {
    ...
    namespace internals {
        ...
        struct ParametersChaining {
            template<typename T>
            static constexpr inline void chain(Parameters::ParametersList &parameters, T &builder) {
            ...
            template<typename T>
            static constexpr inline void chain(Parameters::ParametersMap &parameters, T &builder) {
                const auto builderParameters{builder.build()};
        ...
        struct CommandExecutorImpl<ReleaseHandle> {
            ...
            [[maybe_unused]] inline ResultType execute(Args &&... args) {
                static_assert(
                        std::conjunction_v<std::is_base_of<Device::DeviceHandle,
            ...
            asyncExecute(const Device::DeviceHandle &handle,
                ...
                if (device.asyncSendHttpCommand(COMMAND_RELEASE_HANDLE, {{PARAMETER_NAME_HANDLE, handle.value}},
                                                onComplete,
                                                timeout)) {
                    return {promise->get_future()};
                }
        ...
        struct CommandExecutorImpl<StartScanOutput> {
            ...
            asyncExecute(const Device::DeviceHandle &handle,
                ...
                if (device.asyncSendHttpCommand(COMMAND_START_SCAN_OUTPUT, {{PARAMETER_NAME_HANDLE, handle.value}},
                                                onComplete,
                                                timeout)) {
                    return {promise->get_future()};
                }
        ...
        struct CommandExecutorImpl<StopScanOutput> {
            ...
            asyncExecute(const Device::DeviceHandle &handle,
                ...
                if (device.asyncSendHttpCommand(COMMAND_STOP_SCAN_OUTPUT, {{PARAMETER_NAME_HANDLE, handle.value}},
                                                onComplete,
                                                timeout)) {
                    return {promise->get_future()};
                }
        ...
        struct CommandExecutorImpl<FeedWatchdog> {
            ...
            asyncExecute(const Device::DeviceHandle &handle,
                ...
                if (device.asyncSendHttpCommand(COMMAND_FEED_WATCHDOG, {{PARAMETER_NAME_HANDLE, handle.value}},
                                                onComplete,
                                                timeout)) {
                    return {promise->get_future()};
                }
        ...
        struct CommandExecutorImpl<GetParameters> {
            ...
            asyncExecuteFuture(std::chrono::milliseconds timeout, Args &&... args) {
                static_assert(
                        std::conjunction_v<std::is_base_of<Parameters::ReadOnlyBuilderBase,
                                typename std::decay_t<Args>>...>,
                        "All the provided handle must be of type ReadOnlyBuilderBase");
        ...
        struct CommandExecutorImpl<SetParameters> {
            ...
            [[maybe_unused]] inline ResultType execute(Args &&... args) {
                static_assert(
                        std::conjunction_v<std::is_base_of<Parameters::WriteBuilderBase,
                                typename std::decay_t<Args>>...>,
        ...
        private:
            static std::optional<Parameters::ParametersList>
        ...
        struct CommandExecutorImpl<RequestTcpHandle> {
            ...
            [[maybe_unused]] std::optional<std::future<AsyncResultType>>
            asyncExecute(const Parameters::ReadWriteParameters::TcpHandle &builder,
                         std::chrono::milliseconds timeout) {
                const auto parameters{builder.build()};
                auto promise{std::make_shared<std::promise<AsyncResultType>>()};
                auto onComplete{[promise](const Device::AsyncResult &result) -> void {
        ...
        struct CommandExecutorImpl<RequestUdpHandle> {
            ...
            [[maybe_unused]] std::optional<std::future<AsyncResultType>>
            asyncExecute(const Parameters::ReadWriteParameters::UdpHandle &builder,
                         std::chrono::milliseconds timeout) {
                const auto parameters{builder.build()};
                auto promise{std::make_shared<std::promise<AsyncResultType>>()};
                auto onComplete{[promise](const Device::AsyncResult &result) -> void {
        ...
        struct CommandExecutorImpl<GetScanOutputConfig> {
            ...
            template<typename... Args>
            [[maybe_unused]] ResultType execute(Args &&... args) {
                static_assert(
                        std::conjunction_v<std::is_base_of<Device::DeviceHandle,
                                typename std::decay_t<Args>>...>,
                        "All the provided handle must be of type DeviceHandle");
            ...
            [[maybe_unused]] bool asyncExecute(const Device::DeviceHandle &handle, std::chrono::milliseconds timeout,
                ...
                return device.asyncSendHttpCommand(
                        ...
                        [c = std::move(callable)](const Device::AsyncResult &result) -> void {
                            ...
                            const auto &propertyTree{result.getPropertyTree()};
                            std::invoke(c,
                                        AsyncResultType{result.getRequestResult(), getScanOutputConfig(propertyTree)});
                        },
                        timeout);
            }

        private:
            static std::optional<Parameters::ParametersMap>
        ...
        struct CommandExecutorImpl<SetScanOutputConfig> {
            ...
            [[maybe_unused]] inline ResultType execute(Args &&... args) {
                static_assert(
                        std::conjunction_v<std::is_base_of<Parameters::HandleParameters,
                                typename std::decay_t<Args>>...>,
