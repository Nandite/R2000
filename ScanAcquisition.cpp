 ...
 * @return
 */
template <typename T> std::optional<T> lexicalCast(const std::string& representation)
{
    try
    {
...
template <typename Iterator> void printMapRange(Iterator begin, Iterator end, ostream& stream)
{
    auto count{0u};
...
int main(int argc, char** argv)
{
    ...
    const std::unordered_map<unsigned int, unsigned int> UHD_RESOLUTION_FREQUENCY{
        {72, 50},   {90, 50},   {120, 50},  {144, 50},   {180, 50},   {240, 50},   {360, 50},  {400, 50},  {450, 50},
        {480, 50},  {600, 50},  {720, 50},  {800, 50},   {900, 50},   {1200, 50},  {1440, 50}, {1680, 50}, {1800, 50},
        {2100, 50}, {2400, 50}, {2520, 50}, {2800, 50},  {3150, 50},  {3600, 50},  {4200, 50}, {5040, 50}, {5600, 45},
        {6300, 40}, {7200, 35}, {8400, 30}, {10080, 25}, {12600, 20}, {16800, 15}, {25200, 10}};
    const std::unordered_map<unsigned int, unsigned int> HD_RESOLUTION_FREQUENCY{
        {72, 50},   {90, 50},   {120, 50},  {144, 50},  {180, 50},  {240, 50},  {360, 50},  {400, 50},
        {450, 50},  {480, 50},  {600, 50},  {720, 50},  {800, 50},  {900, 50},  {1200, 50}, {1440, 50},
        {1680, 50}, {1800, 46}, {2100, 40}, {2400, 35}, {2520, 33}, {2800, 30}, {3150, 26}, {3600, 23},
        {4200, 20}, {5040, 16}, {5600, 15}, {6300, 13}, {7200, 11}, {8400, 10}};
    const std::unordered_map<unsigned int, unsigned int> SD_RESOLUTION_FREQUENCY{
        {72, 30},   {90, 30},   {120, 30},  {144, 30},  {180, 30},  {240, 30},  {360, 30},  {400, 30},
        {450, 30},  {480, 30},  {600, 30},  {720, 30},  {800, 30},  {900, 30},  {1200, 30}, {1440, 30},
        {1680, 30}, {1800, 30}, {2100, 30}, {2400, 30}, {2520, 28}, {2800, 25}, {3150, 22}, {3600, 20},
        {4200, 17}, {5040, 14}, {5600, 12}, {6300, 11}, {7200, 10}};
                                                ...
                                                "devices.")("udp",
                                                            ...
                                                            "default TCP.")("address,a",
                                                                            boost::program_options::value<std::string>()
                                                                                ->default_value(""),
                                                                            "Address of the device.")("target,t",
    ...
    else
    {
        ...
        auto handleParameters{
            Device::Parameters::ReadWriteParameters::TcpHandle{}.withPacketType(packetType).withStartAngle(-1800000)};
        if (watchdog)
        {
            handleParameters.withWatchdog().withWatchdogTimeout(*watchdog);
        }
